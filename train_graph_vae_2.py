#v2 is different from v1 in that we use the full batch to train the model and we change the dataloader
...
def train(params:argparse.Namespace):
    ...
    with tqdm(dataloader, dynamic_ncols=True) as tqdmDataLoader:
        for feature_emb_gt, normalized_adj, neighbor_map_gt, labels,  positional_embeddings, neighbor_feats_emb in tqdmDataLoader:
